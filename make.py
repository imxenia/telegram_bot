...
def finalize_appointment(bot, message):
    ...
    bot.send_message(chat_id,
                     f'Спасибо за обращение в нашу студию! Сейчас проверим, свободно ли окошко, и в кратчайшие сроки вернёмся к Вам с ответом🌸'
                     f'\nПредварительно записали Вас на услугу «{service}» {day} в {time}☺️'
                     f'\nДополнительные услуги: {added_service}🌿\n'
                     f'\nСтудия «Xeni_brows» находится по адресу ул. Саврасова, д. 86, ЖК Мандарин. '
                     f'Найти студию можно по метке в Яндекс Картах: https://yandex.ru/maps/org/xeni_brows/36045696998/?ll=39.217077%2C51.611170&z=16 🤍\n'
                     ...
                     f'\nЕсли возникнут какие-либо вопросы - задавайте, с радостью ответим🌸\n')
...
def callback_query(bot, call):
    ...
    # Обработка выбора дополнительных услуг
        ...
        bot.send_message(chat_id, "На какой день хотели бы записаться?\nВведите дату в формате дд.мм\n📆 Например: 01.01")
